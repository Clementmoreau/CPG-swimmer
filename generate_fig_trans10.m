function out=generate_fig_trans10()
...
if Iload==1
    load('init_guess_UPO_trans10');
    Ng=(length(init)-3)/2+1;
    Pertb=0.1*rand(1,N-1); % pertubation in phase variables
    ...
    pp0=[Thg';Phg'];
    init=[0;0;-0.25*pi;Thg'+Pertb';0;Phg'];
end
...
generate_fig_trans10_draw(tps, traj, params);
