function out=generate_fig_sims_draw1(tps, traj, params)
...
dpi = '-r400';
saveas(fig5,'fig_sims_swimL_angle','epsc')
saveas(fig6,'fig_sims_swimL_phase','epsc')
%saveas(fig7,'fig7','epsc') 
saveas(fig8,'fig_sims_swimL_shape','epsc') 
