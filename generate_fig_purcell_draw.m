function out=generate_fig_purcell_draw(tps, traj, params)
...
fig11=figure(11);clf;
set(gcf, 'Position',  [2*figsize, 640, figsize*0.9, figsize*0.8])
    hold on
    scatter3(the1/pi,the2/pi, mod(phi2/pi,2),10,tps,'filled')  
    hold off
...
%saveas(fig9,'fig_purcell9','epsc') 
%saveas(fig10,'fig_purcell0','epsc') 
saveas(fig11,'fig_purcell','epsc') 
